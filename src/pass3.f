...
C     RVN I put GEN4 back, since it is used as function generator in many places
C     in LB. When GEN 0 4 0 is used for skipping files, it needs to be commented out
C     directly in the score.
